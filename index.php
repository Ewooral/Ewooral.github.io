			...
			<div class="top-menu">
				<div class="row">
					<div class="col-md-12 col-offset-0 text-center">
						<div id="fh5co-logo"><a href="index.html" style="font-family:'Gabriela', serif,'Rock Salt', cursive; ">CHURCH OF PENTECOST</a></div>
	...
	<div class="container-wrap">
		<aside id="fh5co-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style=" background: rgb(1, 47, 53)">
				   			...
				   			<div class="col-md-6 col-md-offset-3 text-center">
				   				<div class="slider-text">
					   				<div class="slider-text-inner">
					   					<h1>Two Streams District. Koforidua</h1>
											<h2>Free templates Made by <a href="http://ewooral.inc/" target="_blank">ewooral, Inc.</a></h2>
											
											<p><a class="btn btn-primary "data-toggle="modal" data-target="#myModal" > <i class="icon-play4"></i> Login</a> <a class="btn btn-primary btn-learn">Sign Up <i class="icon-arrow-right3"></i></a></p>
					   				</div>
				   				</div>
				   			</div>
				   		</div>
			   	...
			   	<li style=" background: rgb(17, 0, 32)"> 	<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 text-center">
				   				<div class="slider-text">
					   				<div class="slider-text-inner">
					   					<h1>Two Streams District. Koforidua</h1>
											<h2>Free templates Made by <a href="http://freehtml5.co/" target="_blank">ewooral, Inc.</a></h2>
											<p><a class="btn btn-primary "data-toggle="modal" data-target="#myModal"  ></i> Login</a> <a class="btn btn-primary btn-learn">Sign Up <i class="icon-arrow-right3"></i></a></p>	</div>
					   			</div>
				   			</div>
				   		</div>
			   		</div>
				   			...
				   			<div class="col-md-6 col-md-offset-3 text-center">
				   				<div class="slider-text">
					   				<div class="slider-text-inner text-center">
					   					<h1>Two Streams District. Koforidua</h1>
											<h2>Free templates Made by <a href="http://freehtml5.co/" target="_blank">ewooral, Inc.</a></h2>
											<p><a class="btn btn-primary"data-toggle="modal" data-target="#myModal"  >  Login</a> <a class="btn btn-primary">Sign Up <i class="icon-arrow-right3"></i></a></p></div>
					   			</div>
				   			</div>
				   		</div>
			   		</div>
	...
	<div class="container-wrap">
		<footer id="fh5co-footer" role="contentinfo">
			<div class="col-md-4 text-center">
				<h3>Two Streams District, church of pentecost </h3>            
			</div>
			<div class="col-md-4 text-center">
				<h2><a href="#">churchEwooral</a></h2>
			</div>
			<div class="col-md-4 text-center">
				<p>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="http://ewooral.elia" target="_blank">Ewooral, Inc.</a> Images: <a href="http://ewooralDesigns.elia" target="_blank">EwooralDesigns</a></small>
					</p>
				</div>
			</div>
		</footer>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header justify-content-center">
                        ...
                        <h4 class="title title-up" style="margin-left: 70px; color:#b8ac06; font-family: 'Courier New', Courier, monospace; font-weight: bolder; font-size: 20px; ">TWO STREAMS DISTRICT/ KOFORIDUA.</h4>
                    </div>
